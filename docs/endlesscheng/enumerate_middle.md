...
```python title="2909. Minimum Sum of Mountain Triplets II"
...
```python title="1930. Unique Length-3 Palindromic Subsequences"
...
```python title="3128. Right Triangles"
...
```python title="2874. Maximum Value of an Ordered Triplet II"
...
```python title="447. Number of Boomerangs"
