...
class MarkdownProcessor:
    ...
    def generate_problem_progress(
        self, problems: List[Problem], category: str = "algorithms"
    ) -> str:
    ...
    def generate_topic_content(
        self, config: Config, topic: str, problem_qids: List[int]
    ) -> str:
        ...
        for problem in problems:
            ...
            # Add code content
            code_content = (
                self.code_extractor.extract_code_content(problem) + "\n"
            )
